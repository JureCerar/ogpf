...
contains
    ...
    subroutine preset_gnuplot_config(this)
		...
		! Edited by Jure Cerar
        write(this%file_unit, fmt='(a)') 'set tics nomirror out'
        write(this%file_unit, fmt='(a)')

        write(this%file_unit, fmt='(a)') '# grid'
        write(this%file_unit, fmt='(a)') '# Add light grid to plot'
		! Edited by Jure Cerar
        write(this%file_unit, fmt='(a)') 'set style line 102 lc rgb "#d6d7d9" lt 1 lw 1'
